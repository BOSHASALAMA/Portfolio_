    ...
    <motion.div
      ...
      <div
        ...
        <div
          ...
          className="absolute left-1/6 p-4 top-1/2  flex justify-center items-center  rounded-2xl shadow-md shadow-cyan-600 bg-slate-900 border border-slate-700 group-hover/pin:border-slate-600 transition duration-700 overflow-hidden">
...
export const PinPerspective = ({
  ...
  return (
    <div suppressHydrationWarning={true}>
      <motion.div
        className={cn("pointer-events-none  w-96 h-80 flex items-center justify-center opacity-100 md:opacity-0 md:group-hover/pin:opacity-100 z-20", isMobile ? "" : "transition duration-500")}>
        <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-5 md:top-7  inset-x-0 flex flex-col gap-2 justify-center items-center">
          <div
            suppressHydrationWarning={true}
            onClick={(e) => { e.preventDefault(); e.stopPropagation(); window.open(href, '_blank'); }}
            className="relative flex space-x-2 w-[360px] items-center justify-center z-10 rounded-full bg-slate-900 py-0.5 px-4 ring-1 ring-slate-700/10 cursor-pointer pin-button pointer-events-auto">
            <span
          ...
          {title2 && href2 && (
            <div
              ...
              className="relative flex space-x-2 w-[360px] items-center justify-center z-10 rounded-full bg-slate-900 py-0.5 px-4 ring-1 ring-slate-700/10 cursor-pointer pointer-events-auto">
              <span
                className="relative z-20 text-white text-xs font-bold inline-block py-0.5">
                {title2}
              </span>
          ...
          {!isMobile && (
            <>
              <motion.div
                ...
                className="absolute left-1/2 top-1/2 h-24 w-24 md:h-45 md:w-45 rounded-[50%] bg-sky-500/8 shadow-[0_8px_16px_rgb(0_0_0/0.4)]"></motion.div>
              <motion.div
                suppressHydrationWarning={true}
                initial={{
                  opacity: 0,
