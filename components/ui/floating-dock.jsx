...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden h-16 w-[75%] z-50 items-end justify-center gap-8 rounded-3xl bg-slate-950 shadow-lg shadow-cyan-700 ring-2 ring-cyan-700 px-4 pb-3 md:flex",
        className
      )}>
      {items.map((item) => (
